...
def test_test_slice_args_cover_named_human_slices(tmp_path):
    ...
    assert _test_slice_args("qt", app_root=app_root) == (str(tests_dir / "test_qt_ui.py"),)
    assert _test_slice_args("tui", app_root=app_root) == (str(tests_dir / "test_tui.py"),)
    assert _test_slice_args("integration", app_root=app_root) == (str(tests_dir / "test_integration.py"),)
    assert _test_slice_args("live", app_root=app_root) == (str(tests_dir / "test_live_runtime_suite.py"),)
