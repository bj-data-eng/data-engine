...
ICON_ASSETS: dict[str, SvgIconAsset] = {
    ...
    "dataframe": SvgIconAsset(file_name="dataframe.svg"),
    ...
    "select-all-all": SvgIconAsset(file_name="select-all-all.svg"),
    "select-all-none": SvgIconAsset(file_name="select-all-none.svg"),
    "select-all-partial": SvgIconAsset(file_name="select-all-partial.svg"),
    "settings": SvgIconAsset(file_name="settings.svg"),
    "sort-ascending": SvgIconAsset(file_name="sort-ascending.svg"),
    "sort-descending": SvgIconAsset(file_name="sort-descending.svg"),
