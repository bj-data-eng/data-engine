...
def stop_active_work(service: "DataEngineDaemonService") -> None:
    ...
    with service._state_lock:
        ...
        manual_runtime_stop_events = list(service.state.manual_runtime_stop_events.values())
        manual_flow_stop_events = list(service.state.manual_flow_stop_events.values())
